...
## GitHub Pages Hosting (Live Docs)

PanSSR documentation is GitHub Pages-ready via `docs/index.html` and the Pages workflow.

### Option A (recommended): Automatic deployment with Actions
1. Push this repository with `.github/workflows/pages.yml` present.
2. In GitHub: **Settings → Pages**.
3. Under **Build and deployment**, choose **Source: GitHub Actions**.
4. The workflow **Deploy PanSSR docs to GitHub Pages** will publish from `docs/`.

### Option B: Manual Pages source (no Actions)
1. In **Settings → Pages**, choose **Deploy from a branch**.
2. Select branch `main` (or `master`) and folder `/docs`.
3. Save; GitHub serves `docs/index.html`.

The docs landing page file is:
- `docs/index.html`
